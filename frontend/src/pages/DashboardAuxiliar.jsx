...
export default function DashboardAuxiliar() {
  ...
  const quickActions = [
    ...
    { icon: Calendar, label: "Calendario", to: "/calendario", color: "emerald" },
  ];
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* COLUMNA IZQUIERDA - Anuncios (2/3) */}
        <div className="lg:col-span-2 bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
          ...
          {anuncios && anuncios.length > 0 ? (
            <div className="space-y-4">
              {anuncios.slice(0, 6).map((anuncio, idx) => (
                <div
                  key={idx}
        ...
        {/* COLUMNA DERECHA - Perfil + Acciones (1/3) */}
        <div className="space-y-6">
          ...
          {perfil && (
            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
              <div className="text-center mb-6">
                ...
                <p className="text-sm text-gray-500">{perfil.cargo || "Auxiliar"}</p>
                {perfil.estado && (
              ...
              <div className="space-y-3 text-sm border-t border-gray-100 pt-4">
                ...
                {perfil.vacaciones_pendientes !== undefined && (
                  <div>
                    <p className="text-gray-500 text-xs font-medium">VACACIONES PENDIENTES</p>
          ...
          <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-2xl p-6 border border-emerald-200">
            <div className="flex items-start gap-3">
              <AlertCircle size={20} className="text-emerald-600 flex-shrink-0 mt-1" />
              <div>
                <h3 className="font-bold text-emerald-900 mb-1">Información</h3>
                <p className="text-sm text-emerald-700">
                  Tus cambios se guardan automáticamente. El sistema actualiza tu tareo en tiempo real.
                </p>
              </div>
            </div>
          </div>
